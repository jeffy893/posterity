...
- **Agrarian (Foundational):** Resource extraction, agriculture, food and shelter security — requiring the highest degree of civic engagement.
- **Military (Security):** Enforcement of boundaries, risk management, physical safety — securing the stability for the agrarian base to function.
- **Entrepreneurial (Specialization):** High-value creation leveraging capital and technology — operating within a different DCoV by nature of its scope.
...
- Social capital
- Scope capital
- Structural and cultural interdependencies
- Shared services
...
- **Material Capital:** Assets = Liabilities + Common Stock + Previous Retained Earnings + Revenue − Expenses − Dividends.
- **Social Capital:** Social Power = Social Responsibilities + Common Social Stock + Previous Material Baggage + Exfluences − Influences − Takeables.
- **Scope Capital:** Scope Responsibilities = Scope Power (Focus) + Common Scope Stock + Previous Immaterial Baggage + Educateables − Ignoreables − Shareables.
...
- Prefer optionality over prediction
- Small, reversible bets over large, irreversible ones
- Barbell strategy: extreme safety in the core, calculated risk at the margins
- Skin in the game: do not advise others to take risks you yourself would not take
...
- Healthy, unprocessed food and clean water
- Regular physical activity and outdoor engagement
- Adequate sleep and structured daily rhythms
- Limiting consumption of processed media as rigorously as processed food
...
- **Parkinson's Law:** Work expands to fill the time available for its completion. Institutions consume all resources given to them.
...
- The sentient being associated with the allegedly non-permissible choices has 48 hours to redact the details of the records of said choices.
- Patience and tolerance are among the highest virtues which the jurors must keep in scope.
- The time-and-money-based merit of the sentient being must supersede the temporary breach of expectation.
- A juror must be able to clearly dictate exactly what the breach is in order to have a say in the treatment of the breach.
- If there are no clearly defined damages or duties, negligence and intention cannot be reasonably assigned to the participants in the choices in question.
...
- Know your neighbors. Build relational capital within a 15-mile radius.
- Participate in a local religious or spiritual community.
- Support local agriculture, trades, and small business.
- Engage in third spaces (beyond home and work) with vulnerability and authenticity.
